...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	<form action="${root}/manager_admi/manager_role_update_pro" method="post" id="roleUpdateForm">
                	
                	<input type="hidden" value="${map.role_group_id}" name="roleGroupId">
                    <br>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        	<div class="row">
                        		...
                        		<div class="col-sm-4">
                        			<input type="text" class="form-control" name="roleGroupName" value="${map.role_group_name}">
                        		</div>
                        		<div class="col-sm-1">등록일</div>
                        		<div class="col-sm-2"><input type="text" class="form-control" name="regdate" value="${map.regdate}" readonly="readonly"></div>
                        		<div class="col-sm-1">등록인</div>
                        		<div class="col-sm-2"><input type="text" class="form-control" name="registrar" value="${map.registrar}" readonly="readonly"></div>
                        	</div>
                        	<div class="row">
                        		<div class="col-sm-2">운영자 그룹 설명</div>
                        		<div class="col-sm-10">
                        			<input type="text" class="form-control" name="roleGroupInfo" value="${map.role_group_info}">
                        		</div>
                        	</div>
                        	<div class="row">
                        		...
                        		<div class="col-sm-10 crud-col">
                        			...
                        			<label><input type="checkbox" name="crud" value="2" class="crudChk" checked>&nbsp;Read</label>
                    		...
                    		<div class="text-center">
                    			<button type="button" class="btn btn-info addAlert">수&nbsp;&nbsp;정</button>
                    		</div>
    ...
    <script>
    	$(function(){
    		...
    		<c:forEach items="${map.detailList}" var="obj">
    			$('input[value="'+${obj.detail_role}+'"]').not('input[name="crud"]').prop('checked',true);
    		</c:forEach>
    		
    		<c:forEach items="${map.detailList}" var="obj">
				<c:if test="${obj.crud eq 1}">
					$('input[name="crud"][value="1"]').prop('checked',true);
				</c:if>
				<c:if test="${obj.crud eq 3}">
					$('input[name="crud"][value="3"]').prop('checked',true);
				</c:if>
				<c:if test="${obj.crud eq 4}">
					$('input[name="crud"][value="4"]').prop('checked',true);
				</c:if>
			</c:forEach>
