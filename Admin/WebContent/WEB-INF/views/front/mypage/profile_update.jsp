...
<body>
<form action="${root}/front/mypage/profile_update" method="get" id="proUpdateForm">
    ...
    <section id="BZ002-PF01" class="content">
        ...
        <div class="inner">
            ...
            <div class="box box3">
                ...
                <input type="text" placeholder="가게 프로필명을 입력해주세요." name="shop_name" value="${map.shop_name}">
            </div>
            <div class="box box4">
...
<!--                 <div class="btn sure"><a href="">확인</a></div> -->
<!--             </div> -->
<!--         </div> -->
