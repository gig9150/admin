...
<body>
	...
	<section id="BZ001-TB04-DT01-MAIN" class="content">
		<div class="box top">
			<div class="icon_left">
				<a href="${root}/front/shop/shop_promotion"><i
			...
			<c:choose>
				<c:when test="${checkNum eq 1}">
					<ul class="left_box" id="regularMember">
						...
						<li class="regular regular1" style="display: none;"><a
							href="javascript:void(0);"><i class="fas fa-plus"></i><span>단골</span>${bookmarkCnt}</a></li>
						<li class="regular regular2" style="display: block"><a
							href="javascript:void(0);"><i class="fas fa-plus"></i><span>단골</span>${bookmarkCnt}</a></li>
					</ul>
				</c:when>
				<c:otherwise>
					<ul class="left_box" id="regularMember">
						<li><img src="${root}/img/group_2058.png" alt=""></li>
						<li class="regular regular1" style="display: block;"><a
							href="javascript:void(0);"><i class="fas fa-plus"></i><span>단골</span>${bookmarkCnt}</a></li>
						<li class="regular regular2" style="display: none"><a
							href="javascript:void(0);"><i class="fas fa-plus"></i><span>단골</span>${bookmarkCnt}</a></li>
					</ul>
				</c:otherwise>
			</c:choose>
		...
		<ul class="tab">
			<li><a
				href="${root}/front/shop/shop_detail?shopIdx=${detailMap.shop_idx}">소개</a></li>
			<li><a
				href="${root}/front/shop/shop_news2?shopIdx=${detailMap.shop_idx}">소식</a></li>
			<li><a
				href="${root}/front/shop/shop_review2?shopIdx=${detailMap.shop_idx}">후기</a></li>
		</ul>

		<div class="box notice">
			<a
				href="${root}/front/shop/shop_review_register?shopIdx=${detailMap.shop_idx}"><span><i
					class="fas fa-pencil-alt"></i></span>후기 작성하기</a>
		</div>
				...
				<c:when test="${status.count eq 1}">
					<div class="content content1">
						...
						<div class="box box_1">
							...
							<div class="menuBar">
								<a href="javascript:void(0)" class="수정 "><i
									class="fas fa-ellipsis-v"></i></a>
							</div>
						</div>
			...
			<div class="btn_box">
				...
				<c:choose>
					<c:when test="${checkNum eq 1}">
						<div class="btn sure">
							<a
								href="${root}/front/shop/shop_bookmark?shopIdx=${detailMap.shop_idx}&nowPage=review">확인</a>
						</div>
					</c:when>
					<c:otherwise>
						<div class="btn sure">
							<a
								href="${root}/front/shop/shop_bookmark_cancel?shopIdx=${detailMap.shop_idx}&nowPage=review">확인</a>
						</div>
					</c:otherwise>
				</c:choose>
			</div>
	...
	<script>
		$(function() {
			...
			$('.con_first').click(function(){
				console.log('11');
				location.href='${root}/front/shop/shop_review2?shopIdx=${detailMap.shop_idx}&sort=latest'
			});
			
			$('.con_last').click(function(){
				console.log('22');
				location.href='${root}/front/shop/shop_review2?shopIdx=${detailMap.shop_idx}&sort=like'
			});
