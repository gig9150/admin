...
<body>
<section id="HM008_2" class="content">
        <div class="title_box">
           <ul class="left_box">
                <li><a href="${root}/front/shop/shop_promotion"><i class="fas fa-chevron-left"></i></a></li>
                <li><h1 class="title">가게홍보</h1></li>
            </ul>    
            <ul class="logo_box">
                <li class="search"><a href=""><i class="fas fa-search"></i></a></li>
                <li class="bell"><a href=""><i class="far fa-bell"></i></a></li>
            </ul>
        </div>
        <ul id="gnb">
            <li><a href="">홈</a></li>
        ...
        <div class="top_box">
                ...
                <ul class="recom">
                    <li><a href="">추천 검색어1</a></li>
                    <li><a href="">추천 검색어2</a></li>
                    <li><a href="">추천 검색어3</a></li>
                </ul>
               ...
               <div class="store_box store_box_1">
...
<!--                     <div class="pic"></div> -->
            ...
            <div class="store_box store_box_2">
            ...
            <div class="store_box store_box_3">
               
                <div class="sub_box">

                    <div class="pic">
	                    	<img src="${root}/upload/55.jpg" width="100%" height="100%">
	                    </div>
                    <div class="info">
                        <ul class="sub_info sub_info_1">
                            <li>휘연</li>
