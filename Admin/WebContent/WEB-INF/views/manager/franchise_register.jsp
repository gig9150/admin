        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <br><hr><br>
				<form action="${root}/manager/manage_franchise_register_pro" method="post" id="registerForm" enctype="multipart/form-data">
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body basicInfo">
                        	<div class="row">
                        		...
                        		<div class="col-sm-3"><input type="text" class="form-control" name="franchiseName"></div>
                        		<div class="col-sm-1">주  소</div>
                        		<div class="col-sm-7"><input type="text" class="form-control" name="address"></div>
                        	</div>
                        	<div class="row">
                        		<div class="col-sm-1">고객센터</div>
                        		<div class="col-sm-3"><input type="text" class="form-control" name="customerService"></div>
                        		<div class="col-sm-1">운영 메모</div>
                        		<div class="col-sm-3"><input type="text" class="form-control" name="memo"></div>
                        		<div class="col-sm-1">운영 여부</div>
                        		<div class="col-sm-3">
                        			<label><input type="radio" name="serviceStatus" value="영업중">&nbsp;Y</label>
                        			<label><input type="radio" name="serviceStatus" value="휴업중">&nbsp;N</label>
                        		</div>
                        	</div>
                        	<div class="row">
                        	...
                        	<div class="row">
                        		...
                        		<div class="col-sm-2"><input type="text" name="responName" class="form-control"></div>
                        		<div class="col-sm-2"><input type="text" name="responPhone" class="form-control"></div>
                        		<div class="col-sm-3"><input type="text" name="responEmail" class="form-control"></div>
                        	</div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        	<div class="row">
                        		...
                        		<div class="col-sm-4"><input type="color" name="pointColor"></div>
                        		<div class="col-sm-1">등록 로고</div>
                        		<div class="col-sm-6"><input type="file" name="uploadFile"></div>
                        	</div>
                        	<div class="row">
                        		<div class="col-sm-1">서비스 명</div>
                        		<div class="col-sm-11"><input type="text" class="form-control" name="serviceName"></div>
                        	</div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        	<table class="table">
                        		...
                        		<tbdoy>
                        			<tr>
                        				<td><label><input type="checkbox" name="shopService" class="serviceChk">&nbsp;&nbsp;가게소식</label></td>
                        				<td>
                        					<label><input type="radio" name="shopApproval" value="1" class="approvalYes">&nbsp;Yes</label>
                        					<label><input type="radio" name="shopApproval" value="2" class="approvalNo">&nbsp;No</label>
                        				</td>
                        			</tr>
                        			<tr>
                        				<td><label><input type="checkbox" name="dailyService" class="serviceChk">&nbsp;&nbsp;일상</label></td>
                        				<td>
                        					<label><input type="radio" name="dailyApproval" value="1" class="approvalYes">&nbsp;Yes</label>
                        					<label><input type="radio" name="dailyApproval" value="2" class="approvalNo">&nbsp;No</label>
                        				</td>
                        			</tr>
                        			<tr>
                        				<td><label><input type="checkbox" name="usedService" class="serviceChk">&nbsp;&nbsp;중고거래</label></td>
                        				<td>
                        					<label><input type="radio" name="usedApproval" value="1" class="approvalYes">&nbsp;Yes</label>
                        					<label><input type="radio" name="usedApproval" value="2" class="approvalNo">&nbsp;No</label>
                        				</td>
                        			</tr>
                        			<tr>
                        				<td><label><input type="checkbox" name="directTradeService" class="serviceChk">&nbsp;&nbsp;산지직거래</label></td>
                        				<td>
                        					<label><input type="radio" name="directTradeApproval" value="1" class="approvalYes">&nbsp;Yes</label>
                        					<label><input type="radio" name="directTradeApproval" value="2" class="approvalNo">&nbsp;No</label>
                        				</td>
                        			</tr>
                        			<tr>
