        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> 관리자계정 관리 > 관리자 역할 관리</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="get" action="${root}/manager/manage_role">
	                        <div class="card-body">
	                            <div class="row">
	                                <div class="col-sm-2">
	                                    <select style="width:100%;height:100%;" name="searchOption">
	                                        <option value="franchise_code" <c:if test="${searchOption eq 'franchise_code'}">selected</c:if>>가맹사 코드</option>
	                                        <option value="role_group_name" <c:if test="${searchOption eq 'role_group_name'}">selected</c:if>>역할그룹</option>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <table class="table">
                                <thead class="thead-dark">
                                  <tr>
                                    ...
                                    <th scope="col">#</th>
                                    <th scope="col">가맹사 코드</th>
                                    <th scope="col">역할 그룹명</th>
                                ...
                                <tbody>
                                	<c:forEach items="${roleGroupsList}" var = "obj">
	                           			<tr>
		                                	...
		                                	<th scope="row">${obj.role_group_id}</th>
	                                    	<td>${obj.franchise_code}</td>
	                                    	<td>${obj.role_group_name}</td>
	                                    	<td>${obj.role_group_info}</td>
	                                    	<td>${obj.regdate}</td>
	                                    	<td>${obj.registrar}</td>
	                                    	<td><a href="${root}/manager/manage_role_update?roleGroupId=${obj.role_group_id}">수정</a></td>
	                                    	<td><a href="${root}/manager/manage_role/delete?roleGroupId=${obj.role_group_id}&page=${pageBean.page}&searchOption=${searchOption}&keyWord=${keyWord}">삭제</a></td>
	                               		</tr>                                	
                                	</c:forEach>
                                </tbody>
                              </table>
                              ...
                              <div class="row justify-content-md-center">
				          		...
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
				          				<a class="page-link" href="${root}/manager/manage_role?page=${pageBean.prevPage}" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										        <span class="sr-only">Previous</span>
									      	</a></li>
				          			</c:otherwise>
				          		...
				          		<c:forEach var="idx" begin="${pageBean.min}" end="${pageBean.max}">
				          			<c:choose>
				          				<c:when test="${idx == pageBean.page}">
				          					<li class="page-item active"><a class="page-link" href="${root}/manager/manage_role?page=${idx}">${idx}</a></li>
				          				</c:when>
				          				<c:otherwise>
				          					<li class="page-item"><a class="page-link" href="${root}/manager/manage_role?page=${idx}">${idx}</a></li>
				          				</c:otherwise>
				          			</c:choose>	
				          		</c:forEach>
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
										      <a class="page-link" href="${root}/manager/manage_role?page=${pageBean.nextPage}&" aria-label="Next">
										        <span aria-hidden="true">&raquo;</span>
										        <span class="sr-only">Next</span>
										      </a>
										    	</li>
				          ...
				          <br>
                          <a href="${root}/manager/manage_role_register" class="btn btn-primary btn-lg" style="width:300px;position:relative;margin:-5px -150px;top:50%;left:50%;">등록</a>
                          <br>
                        </div>
                    </div>
                </div>
