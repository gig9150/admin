...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> 관리자 계정관리 > 관리자 계정관리 > 수정 </h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="${root}/manager/manage_account_update_pro" id="managerRegister">
								<div class="form-group">
								  ...
								  <select class="form-control" id="managerFranchise" name="franchiseId">
								    <c:forEach items="${franchiseList}" var="obj">
								    	<option value="${obj.franchise_id}" <c:if test="${managerInfoMap.franchise_id eq obj.franchise_id}">selected</c:if>>${obj.franchise_code} / ${obj.franchise_name}</option>
								    </c:forEach>
								  </select>
								</div>
								<div class="form-group">
									...
									<select class="form-control" id="managerRoleGroup" name="roleGroupId">
										<c:forEach items="${roleGroupsList}" var="obj">
											<option value="${obj.role_group_id}" data-id="${obj.franchise_id}" <c:if test="${managerInfoMap.role_group_id eq obj.role_group_id}">selected</c:if>>${obj.role_group_name}</option>
										</c:forEach>
									</select>
								</div>
								<h6>관리자 추가 권한</h6>
								...
								<input type="hidden" name="franchiseManagerId" value="${managerInfoMap.franchise_manager_id}" />
								
								<div class="form-group">
								    <label for="exampleInputEmail1">아이디</label>
								    <input type="text" class="form-control" id="managerId" aria-describedby="emailHelp" name="managerId" onkeypress="resetIdExist()" required="required" value="${managerInfoMap.id}">
							  	</div>
							  	<div class="form-group">
							  	...
							  	<div class="form-group">
								    ...
								    <input type="text" class="form-control" id="exampleInputPassword1" name="managerName" required="required" value="${managerInfoMap.name}">
							  	</div>
								<div class="form-group">
								    <label for="exampleInputPassword1">핸드폰 번호</label>
								    <input type="text" class="form-control" id="exampleInputPassword1" name="managerPhone" required="required" value="${managerInfoMap.phone}"> 
							  	</div>
							  	<div class="form-group">
								...
								<div class="form-group">
								    ...
								    <input type="text" class="form-control" id="exampleInputPassword1" name="managerEmail" value="${managerInfoMap.email}">
							  	</div>
    ...
    <script type="text/javaScript">
    	...
    	$(function(){
    		...
    		const originalId = '${managerInfoMap.id}';
