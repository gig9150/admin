        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> 관리자계정 관리 > 관리자 역할 관리 > 역할 그룹 수정 </h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">역할 그룹 수정</h6>
                        </div>
                        <div class="card-body">
                            <form method="post" action="${root}/manager/manage_role_update_pro">
                            	<input type="hidden" name="roleGroupId" value="${roleGroupId}">
								<div class="form-group">
								    <label for="exampleInputEmail1">역할 그룹 이름</label>
								    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="roleGroupName" value="${groupsMap.role_group_name}">
							  	</div>
							  	<div class="form-group">
							    	<label for="exampleFormControlTextarea1">역할 그룹 설명 </label>
							    	<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="roleGroupInfo">${groupsMap.role_group_info}</textarea>
							  	</div>
								<div class="form-group">
								    <label for="exampleInputPassword1">가맹점 코드</label>
								    <input type="text" class="form-control" id="exampleInputPassword1" name="franchiseManagerCode" placeholder="등록시 해당 가맹사만 등록 가능합니다." value="${groupsMap.franchise_code}">
							  	</div>
							  	<c:forEach items="${roleDetailList}" var="obj">
									  ...
									  <c:forEach items="${roleGroupDetail}" var="obj2">
									  	<c:if test="${obj.role_detail_id eq obj2}">
									  		checked
									  	</c:if>
									  </c:forEach>
									  >
