            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="get" action="${root}/account_manage/member">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<select class="form-control" name="withdrawal">
											<option value="100" <c:if test="${bean.withdrawal eq 100}">selected</c:if>>전체</option>
											<option value="1" <c:if test="${bean.withdrawal eq 1}">selected</c:if>>정상</option>
											<option value="2" <c:if test="${bean.withdrawal eq 2}">selected</c:if>>탈퇴</option>
										</select>
									</div>
									<div class="col-sm-1">
										회원 정보
									...
									<div class="col-sm-2">
										<select class="form-control" name="select">
											...
											<option value="2" <c:if test="${bean.select eq 2}">selected</c:if>>회원 번호</option>
										</select>
									</div>
									<div class="col-sm-4">
                            ...
                            <table class="table question-table" id="franchiseListTable" style="margin-top:1rem;">
                              ...
                              <div class="row justify-content-md-center">
				          		...
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
				          				<a class="page-link" href="${root}/account_manage/member?page=${pageBean.prevPage}&selectNum=${selectNum}&startDate=${bean.startDate}&endDate=${bean.endDate}&select=${bean.select}&keyWord=${bean.keyWord}&franchiseId=${bean.franchiseId}&id=${bean.id}&penalty=${bean.penalty}&withdrawal=${bean.withdrawal}" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										        <span class="sr-only">Previous</span>
									      	</a></li>
				          			</c:otherwise>
				          		...
				          		<c:forEach var="idx" begin="${pageBean.min}" end="${pageBean.max}">
				          			<c:choose>
				          				<c:when test="${idx == pageBean.page}">
				          					<li class="page-item active"><a class="page-link" href="${root}/account_manage/member?page=${idx}&selectNum=${selectNum}&startDate=${bean.startDate}&endDate=${bean.endDate}&select=${bean.select}&keyWord=${bean.keyWord}&franchiseId=${bean.franchiseId}&id=${bean.id}&penalty=${bean.penalty}&withdrawal=${bean.withdrawal}">${idx}</a></li>
				          				</c:when>
				          				<c:otherwise>
				          					<li class="page-item"><a class="page-link" href="${root}/account_manage/member?page=${idx}&selectNum=${selectNum}&startDate=${bean.startDate}&endDate=${bean.endDate}&select=${bean.select}&keyWord=${bean.keyWord}&franchiseId=${bean.franchiseId}&id=${bean.id}&penalty=${bean.penalty}&withdrawal=${bean.withdrawal}">${idx}</a></li>
				          				</c:otherwise>
				          			</c:choose>	
				          		</c:forEach>
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
										      <a class="page-link" href="${root}/account_manage/member?page=${pageBean.nextPage}&selectNum=${selectNum}&startDate=${bean.startDate}&endDate=${bean.endDate}&select=${bean.select}&keyWord=${bean.keyWord}&franchiseId=${bean.franchiseId}&id=${bean.id}&penalty=${bean.penalty}&withdrawal=${bean.withdrawal}" aria-label="Next">
										        <span aria-hidden="true">&raquo;</span>
										        <span class="sr-only">Next</span>
										      </a>
										    	</li>
	...
	<script>
		$(function(){
   			...
   			$('#selectNum').on('change',function(){
   				...
   				location.href='${root}/account_manage/member?startDate=${bean.startDate}&endDate=${bean.endDate}&select=${bean.select}&keyWord=${bean.keyWord}&franchiseId=${bean.franchiseId}&id=${bean.id}&penalty=${bean.penalty}&withdrawal=${bean.withdrawal}&selectNum='+selectNum;
   			});
   			...
   			$('.question-table tbody tr td').not('.tableTd,.penaltyTd').on('click',function(){
   				...
   				window.open("${root}/account_manage/member_detail?memberId="+memberId,"_blank",
