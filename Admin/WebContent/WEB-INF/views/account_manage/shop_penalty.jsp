        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	<form action="${root}/account_manage/shop_penalty_register" method="post" id="penaltyRegiForm">
                    <br>
							...
							<table class="table table-borderless" style="text-align: center;">
								...
								<tbody>
									<tr>
										...
										<td>가맹사</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${shopMap.franchiseName}"></td>
										<td>가게명</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${shopMap.shopName}"></td>
										<td>가게번호</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${shopMap.shopIdx}" name="shopIdx"></td>
									</tr>
									<tr>
										<td>등록지역</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${shopMap.areaName}"></td>
										<td>발견 경로</td>
										<td>
	                    ...
	                    <div class="card-body">
	                        	...
	                        	<tbody>
	                        		<c:forEach items="${peList}" var="obj">
		                        		...
		                        		<tr>
		                        			...
		                        			<td>
		                        			<c:choose>
		                        				<c:when test="${endDate - strDate >= 0}"><button class="btn btn-secondary penalty-del">패널티 해지</button></c:when>
	                        ...
	                        <div class="row justify-content-md-center">
				          		...
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
				          				<a class="page-link" href="${root}/account_manage/shop_penalty?page=${pageBean.prevPage}&shopIdx=${shopMap.shopIdx}&franchiseName=${shopMap.franchiseName}&shopName=${shopMap.shopName}&areaName=${shopMap.areaName}" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										        <span class="sr-only">Previous</span>
									      	</a></li>
				          			</c:otherwise>
				          		...
				          		<c:forEach var="idx" begin="${pageBean.min}" end="${pageBean.max}">
				          			<c:choose>
				          				<c:when test="${idx == pageBean.page}">
				          					<li class="page-item active"><a class="page-link" href="${root}/account_manage/shop_penalty?page=${idx}&shopIdx=${shopMap.shopIdx}&franchiseName=${shopMap.franchiseName}&shopName=${shopMap.shopName}&areaName=${shopMap.areaName}">${idx}</a></li>
				          				</c:when>
				          				<c:otherwise>
				          					<li class="page-item"><a class="page-link" href="${root}/account_manage/shop_penalty?page=${idx}&shopIdx=${shopMap.shopIdx}&franchiseName=${shopMap.franchiseName}&shopName=${shopMap.shopName}&areaName=${shopMap.areaName}">${idx}</a></li>
				          				</c:otherwise>
				          			</c:choose>	
				          		</c:forEach>
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
										      <a class="page-link" href="${root}/account_manage/shop_penalty?page=${pageBean.nextPage}&shopIdx=${shopMap.shopIdx}&franchiseName=${shopMap.franchiseName}&shopName=${shopMap.shopName}&areaName=${shopMap.areaName}" aria-label="Next">
										        <span aria-hidden="true">&raquo;</span>
										        <span class="sr-only">Next</span>
										      </a>
										    	</li>
