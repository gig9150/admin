        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	<form action="${root}/account_manage/shop_penalty_detail_pro" method="post" id="penaltyUpdateForm">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
							<table class="table table-borderless" style="text-align: center;">
								...
								<tbody>
									<tr>
										<td rowspan="4"><img src="${root}/upload/${memMap.main_image}"></td>
										<td>가맹사</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${memMap.franchise_name}"></td>
										<td>가게명</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${memMap.shop_name}"></td>
										<td>가게번호</td>
										<td><input type="text" class="form-control" readonly="readonly" value="${memMap.shop_idx}"></td>
									</tr>
									<tr>
										<td>패널티 등록일</td>
										...
										<td>패널티 번호</td>
										<td><input type="text" class="form-control" readonly="readonly" name="shopPenaltyId" value="${memMap.shop_penalty_id}"></td>
									</tr>
									<tr>
										<td>발견 경로</td>
										<td>
	                    ...
	                    <div class="card-body">
	                        <table class="table">
	                        	...
	                        	<tbody>
	                        		<c:forEach items="${list}" var="obj">
		                        		<tr>
		                        			<td>${obj.shop_penalty_update_id}</td>
		                        			<td>${obj.regdate}</td>
		                        			<td><c:choose>
	                        ...
	                        <div class="row justify-content-md-center">
				          		...
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
				          				<a class="page-link" href="${root}/account_manage/shop_penalty_detail?page=${pageBean.prevPage}&shopPenaltyId=${shopPenaltyId}" aria-label="Previous">
										        <span aria-hidden="true">&laquo;</span>
										        <span class="sr-only">Previous</span>
									      	</a></li>
				          			</c:otherwise>
				          		...
				          		<c:forEach var="idx" begin="${pageBean.min}" end="${pageBean.max}">
				          			<c:choose>
				          				<c:when test="${idx == pageBean.page}">
				          					<li class="page-item active"><a class="page-link" href="${root}/account_manage/shop_penalty_detail?page=${idx}&shopPenaltyId=${shopPenaltyId}">${idx}</a></li>
				          				</c:when>
				          				<c:otherwise>
				          					<li class="page-item"><a class="page-link" href="${root}/account_manage/shop_penalty_detail?page=${idx}&shopPenaltyId=${shopPenaltyId}">${idx}</a></li>
				          				</c:otherwise>
				          			</c:choose>	
				          		</c:forEach>
				          		<c:choose>
				          			...
				          			<c:otherwise>
				          				<li class="page-item">
										      <a class="page-link" href="${root}/account_manage/shop_penalty_detail?page=${pageBean.nextPage}&shopPenaltyId=${shopPenaltyId}" aria-label="Next">
										        <span aria-hidden="true">&raquo;</span>
										        <span class="sr-only">Next</span>
										      </a>
										    	</li>
   ...
   <script>
   		...
   		$(function(){
   			...
   			$('#penaltyUpdateForm').submit(function(e){
   				...
   				if(!chk){
   					e.preventDefault();
   					location.href="${root}/account_manage/shop_penalty_detail?shopPenaltyId=${shopPenaltyId}";
   				}
   			});
