		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Home >> 콘텐츠 관리 >> 가게 콘텐츠 관리</h1>
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item"><a class="nav-link active" href="${root}/account_manage/news_manage">소식글 관리</a></li>
						<li class="nav-item"><a class="nav-link" href="javascript:void(0)">산지직거래 상품</a></li>
					</ul>
								...
								<div class="row">
									...
									<div class="col-sm-2">
										<select class="form-control" name="penaltyName">
											...
											<option value="2">새소식</option>
											<option value="3">이벤트</option>
											<option value="4">할인</option>
											<option value="5">임시휴업</option>
										</select>
									</div>
									<div class="col-sm-2">
										<label><input type="checkbox">&nbsp;쿠폰첨부</label>
									</div>
									<div class="col-sm-2">
										<label><input type="checkbox">&nbsp;신고여부</label>
									</div>
									<div class="col-sm-2">
										<label><input type="checkbox">&nbsp;게시대기</label>
									</div>
									...
									<div class="col-sm-2">
										<select class="form-control" name="state">
											...
											<option value="1"
												<c:if test="${bean.state eq 1}">selected</c:if>>진열</option>
											<option value="2"
												<c:if test="${bean.state eq 2}">selected</c:if>>미진여</option>
										</select>
									</div>
								</div>
								<div class="row">
